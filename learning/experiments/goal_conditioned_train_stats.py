...
num_models = 3 # must be odd and > 3
...
for i in range(num_models):
    for train_num_blocks in all_train_num_blocks:
        ...
        train_datasets[(i, train_num_blocks)] = generate_world_dataset(args, train_num_blocks, 'train')

test_datasets = {}
for test_num_blocks in all_test_num_blocks:
    print('Generating test dataset with %i blocks' % train_num_blocks)
    test_datasets[test_num_blocks] = generate_world_dataset(args, test_num_blocks, 'test')
