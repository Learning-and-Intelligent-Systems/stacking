...
class PointNetEncoder(nn.Module):
    def __init__(self, global_feat=True, feature_transform=True, channel=3):
        ...
        self.conv3 = torch.nn.Conv1d(64, 512, 1)  # 128, 1024
        self.bn1 = nn.BatchNorm1d(32)  # 64
        self.bn2 = nn.BatchNorm1d(64)  # 128
        self.bn3 = nn.BatchNorm1d(512)  # 1024
...
class PointNetClassifier(nn.Module):
    def __init__(self, n_in):
        ...
        self.fc1 = nn.Linear(512, 256)  # 1024, 512
        self.fc2 = nn.Linear(256, 128)  # 512, 256
        self.fc3 = nn.Linear(128, 1)  # 256, 1
        self.dropout = nn.Dropout(p=0.)  # 0.4
        self.bn1 = nn.BatchNorm1d(256)  # 512
