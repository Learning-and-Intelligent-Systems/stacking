...
if __name__ == '__main__':
    ...
    #try:
    num_goals = 10
    num_plan_attempts = 10
    all_plan_num_blocks = [2, 3, 4, 5, 6, 7, 8]

    model_paths = ['learning/experiments/logs/models/2_random-20210715-164545',
                    'learning/experiments/logs/models/3_random-20210715-164616',
                    'learning/experiments/logs/models/4_random-20210715-164645',
	                'learning/experiments/logs/models/5_random-20210715-164707']
        ...
        for plan_num_blocks in all_plan_num_blocks:
            ...
            for _ in range(num_goals):
                ...
                for _ in range(num_plan_attempts):
                    ...
                    found_plan, plan_exp_path = plan.run(world, goal, plan_args)
                    if found_plan:
                        ...
                        success = False
                    print_state(goal, test_world.num_objects)
                    print('$$$$$$$$', success)
