...
RANDOM_PATH = 'learning/experiments/logs/towers-seq-init-random-blocks-10-fcgn-20210106-112636/'
...
def plot_regret(random_logger, bald_logger, fname):
    ...
    for name, logger in zip(['Seq', 'Global'], [random_logger, bald_logger]):
    ...
    plt.savefig('learning/evaluate/plots/%s_seq.png' % fname)
